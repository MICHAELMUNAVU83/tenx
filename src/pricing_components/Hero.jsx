...
const Hero = () => {
  const features = [
    {
      name: "Hyper-Customized Email Messaging",
      icon1: <IoIosCheckmarkCircle />,
      icon2: <IoIosCheckmarkCircle />,
      icon3: <IoIosCheckmarkCircle />,
      icon4: <IoIosCheckmarkCircle />,
    },
    {
      name: "Hyper-Customized Email Messaging",
      icon1: <IoIosCheckmarkCircle />,
  ...
  return (
    <>
      <div class="bg-[#F3F2EF] p-8 flex flex-col gap-4 justify-center items-center">
        ...
        <p class="md:text-4xl text-3xl font-bold mt-6 text-center my-2">
      ...
      <div class="flex flex-col justify-center items-center w-[100%] bg-black py-6">
        <p class="text-5xl text-center font-semibold text-white">
          Explore The Features
        </p>

        <div class=" w-[100%] overflow-scroll p-4">
          <table class="w-[100%] rounded-sm bg-white p-4 table-auto ">
            <thead class="w-[100%]">
              <tr>
                <th class="text-xl font-semibold">Feature</th>
                <th class="md:text-4xl  text-xl font-semibold">Starter</th>
                <th class="md:text-4xl  text-xl px-2 font-semibold">
                  Professional
                </th>
                <th class="md:text-4xl  text-xl px-2 font-semibold"> Elite</th>
                <th class="md:text-4xl  text-xl px-2 font-semibold">Custom</th>
              </tr>
            </thead>
            <tbody>
              {features.map((feature) => (
                <tr class="text-center w-[100%]">
                  <td class="text-[#252430]  ">
                    <p class="w-[40%] md:text-base text-xs mx-auto text-start">
                      {feature.name}
                    </p>
                  </td>
                  <td>

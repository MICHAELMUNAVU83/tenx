...
const Maximize = () => {
  const meetings = [
    {
      ...
      class: "flex justify-between items-start p-8",
    ...
    },
    {
      ...
      class: "flex flex-row-reverse justify-between items-start p-8",
  ...
  return (
    <div class="bg-black p-12 flex justify-center items-center flex-col gap-8">
      <p class="text-6xl  w-[80%] mx-auto text-white text-center font-semibold">
        Maximize your sales with minimal effort
      </p>
      <div class="bg-[#FF2400] w-[80%] mx-auto flex flex-col gap-4 p-4">
        ...
        {meetings.map((meeting) => (
          <div
            class={`bg-[#323232] w-[100%] h-[250px] ${meeting.class} rounded-md gap-4`}
          >
            ...
            <div class="w-[45%] flex flex-col  text-white gap-4">
